...
/*   Updated: 2020/03/07 13:21:25 by gemerald         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					validate_binary(t_dsm *src_code, t_flags *has_flag);
...
int					fill_new_file(t_dsm *src_code, t_flags *has_flag);
int					take_new_name(t_dsm *src_code, char *old_name);

t_flags				*free_structure(t_flags	*flags);
int					is_flag(char *test, t_flags *flag, int *count, char **av);
